...
def get_jobposting():
    ...
    outfile_path='/home/hamyna/Documents/Git/BullFrogIT/Jobs-WebsScrapping/Results/Github/jobPosting_gitHub.csv'
    # open it up, the w means we will write to it
    writer = csv.writer(open(outfile_path, 'w'))
    #create a list with headings for our columns
    headers = ['title', 'location', 'type', 'description', 'company', 'how_to_apply']
    ...
    while i<6:
        ...
        url = urllib2.Request('https://jobs.github.com/positions.json?description&location=north+america&page=' + str(i))
